...
[
    ...
    { name: "monitor", path: "/monitor", forwardTo: "monitor.subsection" },
    { name: "monitor.subsection", path: "/:subsection/:count/:offset", defaultParams: config.subnavigationDefaultParamsMonitor },
